...
publication = "Atlantic Canada Economic Review, *forthcoming*"
publication_short = "Atlantic Canada Economic Review, *forthcoming*"
...
url_custom = [{name = "Ungated WP", url = "files/tombe_ACER_2022.pdf"}]
